...
error NOT_APPLIABLE, "only a compound, an interface or a protocol can be applied to something else"
...
error NOT_IN_TARGETED, "not in a targeted block"
error NOT_IN_PROJECT, "not in a project block"
error FAILURE_PROCESSING, "a failure ocurred when processing"
